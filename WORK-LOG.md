...
## 12. 디자인 개선 5종 (2026-09-02, 사용자 일괄 승인)
- 네비게이션 상시 CTA 버튼(문의하기/Contact) — 세일즈 전환 강화
- Advisory 카드 04(강연)·05(백서)에 직접 문의 CTA 링크 (KR; EN은 강연 카드)
...
## 15. 하네스 엔지니어링 IITP 기고 링크 추가 (2026-09-03)
- 메인 KR/EN Latest Insights 카드에 IITP 주간기술동향 기고 표기 및 공식 원문 링크 추가
- Insights 허브와 KR/EN 상세 글 상단에 IITP 공식 원문 링크 추가
- 기존 자체 PDF 링크는 함께 유지

## 16. KV 캐시(TurboQuant) IITP 기고 링크 추가 (2026-09-03)
- 메인 KR/EN Latest Insights 카드에 IITP 주간기술동향 기고 표기 및 공식 원문 링크 추가
- Insights 허브와 KR/EN 상세 글 상단에 IITP 공식 원문 링크 추가
